...
; TODO: replace mew.4bpp / mew.gbapal with Rayquaza art (e-Reader card preview only;
; the in-game battle sprite comes from the cartridge ROM, not the card).
TicketSprite: ; 104
	INCBIN "mew.4bpp"
TicketPalette: ; 1604
	INCBIN "mew.gbapal"
...
DeliveryInProcess: ; 1a0d
	db "RAYQUAZA EVENT delivery in Progress...\0"

TicketDelivered: ; 1a2f
	db "RAYQUAZA EVENT delivered!\n"
	db "\n"
